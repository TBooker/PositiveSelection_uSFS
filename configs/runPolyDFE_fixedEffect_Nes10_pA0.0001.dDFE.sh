...
~/bin/polyDFE-master/polyDFE-2.0-linux-64-bit -d ~/projects/def-whitlock/booker/uSFS_positiveSelection/polyDFE_fixedEffect/polyDFE_runs_n20/Nes10_pA0.0001_n20_polyDFE/$SLURM_ARRAY_TASK_ID.polyDFE_T1.config  -i ~/bin/polyDFE-master/input/init_model_BandC.txt 2 -m B > ~/projects/def-whitlock/booker/uSFS_positiveSelection/polyDFE_fixedEffect/polyDFE_runs_n20/Nes10_pA0.0001_n20_polyDFE/$SLURM_ARRAY_TASK_ID.polyDFE_T1.wDiv.dDFE.B.output

~/bin/polyDFE-master/polyDFE-2.0-linux-64-bit -d ~/projects/def-whitlock/booker/uSFS_positiveSelection/polyDFE_fixedEffect/polyDFE_runs_n20/Nes10_pA0.0001_n20_polyDFE/$SLURM_ARRAY_TASK_ID.polyDFE_T1.config -i ~/bin/polyDFE-master/input/init_model_BandC.txt 2 -m B -w > ~/projects/def-whitlock/booker/uSFS_positiveSelection/polyDFE_fixedEffect/polyDFE_runs_n20/Nes10_pA0.0001_n20_polyDFE/$SLURM_ARRAY_TASK_ID.polyDFE_T1.nDiv.dDFE.B.output
