...
#~/bin/polyDFE-master/polyDFE-2.0-linux-64-bit -d ~/projects/def-whitlock/booker/uSFS_positiveSelection/polyDFE_fixedEffect/polyDFE_runs_n20/Nes100_pA0.0001_n20_polyDFE/$SLURM_ARRAY_TASK_ID.polyDFE_T1.config  -m B -e  > ~/projects/def-whitlock/booker/uSFS_positiveSelection/polyDFE_fixedEffect/polyDFE_runs_n20/Nes100_pA0.0001_n20_polyDFE/$SLURM_ARRAY_TASK_ID.polyDFE_T1.wDiv.Be.output

~/bin/polyDFE-master/polyDFE-2.0-linux-64-bit -d ~/projects/def-whitlock/booker/uSFS_positiveSelection/polyDFE_fixedEffect/polyDFE_runs_n20/Nes100_pA0.0001_n20_polyDFE/$SLURM_ARRAY_TASK_ID.polyDFE_T1.config -w -m B -e  > ~/projects/def-whitlock/booker/uSFS_positiveSelection/polyDFE_fixedEffect/polyDFE_runs_n20/Nes100_pA0.0001_n20_polyDFE/$SLURM_ARRAY_TASK_ID.polyDFE_T1.nDiv.Be.output
